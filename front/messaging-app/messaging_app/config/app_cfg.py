# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in messaging-app.
...
from messaging_app import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': messaging_app.model,
    'DBSession': messaging_app.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "2dc01921-3cc0-4832-8717-a1f913e11ce0",
