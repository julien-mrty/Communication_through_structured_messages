...
It's perfectly fine to re-use this definition in the messaging-app application,
though.
...
from messaging_app.model import DeclarativeBase, metadata, DBSession
...
class User(DeclarativeBase):
    ...
    def _hash_password(cls, password):
        password = pbkdf2_hmac(
            ...
            b"7a8f3923-16c0-4ad7-9d2e-22bf4c4e897a",
            iterations=100_000
        ).hex()
